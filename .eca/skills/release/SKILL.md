...
The rendered formula is at `out/build/dexter.rb`. It needs to be copied to the `hlship/brew` Homebrew tap repository.

Ask the user where their local clone of `hlship/brew` is (likely at `/Users/howard.lewisship/workspaces/hlship/brew`), then:
